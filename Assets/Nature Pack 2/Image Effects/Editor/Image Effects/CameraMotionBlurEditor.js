...
{	
  ...
  var preview_Scale : SerializedProperty;
  ...
  //var dynamicLayers : SerializedProperty;
    ...
    preview_ = serObj.FindProperty ("preview_");
    preview_Scale = serObj.FindProperty ("preview_Scale");
  ...
  function OnInspectorGUI () {         
    ...
    EditorGUILayout.PropertyField (preview_, new GUIContent("preview_"));
    if (preview_.boolValue)
      EditorGUILayout.PropertyField (preview_Scale, new GUIContent(""));    
